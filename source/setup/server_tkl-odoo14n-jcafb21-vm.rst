...
.. index:: Criação do Servidor Local tkl-odoo14n-jcafb21-vm

==================================================
Criação do Servidor Local "tkl-odoo14n-jcafb21-vm"
==================================================
...
--------------
    ...
    #. Create a new Virtual Machine using the following parameters:
        ...
        - Set a VM Name and a VM Location of your preference (**tkl-odoo14n-jcafb21-vm** - **D:\\vm\\tkl-odoo14n-jcafb21-vm**).
    ...
    #. Update host name, executing the following commands:
        ...
        ::
            ...
            HOSTNAME=tkl-odoo14n-jcafb21-vm
        ...
        * `Using an SSH Tunnel <http://confluence.dbvis.com/display/UG91/Using+an+SSH+Tunnel>`_ 
        ...
        #. :red:`(Not Used)` To  establish a secure tunnel from the remote computer, use one the following commands (change the local port (5432) and the remote port (33335) appropriately):
            ...
            ::
                ...
                ssh -v -L 33335:localhost:5432 root@tkl-odoo14n-jcafb21-vm

            ::

                ssh -L 33335:localhost:5432 root@tkl-odoo14n-jcafb21-vm

            ::

                ssh -v -L 33335:127.0.0.1:5432 root@tkl-odoo14n-jcafb21-vm

            ::

                ssh -L 33335:127.0.0.1:5432 root@tkl-odoo14n-jcafb21-vm
...
-----------
    ...
    #. To install xlrd 1.1.0, execute the following commands (as root):
        ...
        ::
            ...
            root@tkl-odoo14n-jcafb21-vm .../clvsol_clvhealth_jcafb/project# pip3 install xlrd
            Requirement already satisfied: xlrd in /usr/lib/python3/dist-packages (1.1.0)
            root@tkl-odoo14n-jcafb21-vm .../clvsol_clvhealth_jcafb/project# pip3 install xlwt
            Collecting xlwt
            ...
            root@tkl-odoo14n-jcafb21-vm .../clvsol_clvhealth_jcafb/project# pip3 install xlutils
            Collecting xlutils
    ...
    #. To install Jinja2-2.11.2, execute the following commands (as root):
        ...
        * Issue:
        ...
        ::
            ...
            root@tkl-odoo14n-jcafb21-vm ~# pip3 install -U Jinja2
            Collecting Jinja2
...
-------------------------
    ...
    #. To install all "**modules**", use the following commands (as odoo):
        ...
        ::
            ...
            ssh tkl-odoo14n-jcafb21-vm -l odoo
