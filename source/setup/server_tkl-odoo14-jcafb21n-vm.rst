...
==================================================
Criação do Servidor Local "tkl-odoo14-jcafb21n-vm"
==================================================

    This project will help you create a server to host the **Odoo 14 (CLVhealth-JCAFB)** solution, based on an `Odoo <https://www.odoo.com/>`_  appliance, using the VMWare Workstagion infrastructure.
...
------------------
    ...
    #. Create a new Virtual Machine using the following parameters:
        ...
        - Set a VM Name and a VM Location of your preference (**tkl-odoo14-jcafb21n-vm** - **D:\\vm\\tkl-odoo14-jcafb21n-vm**).
...
---------------
    ...
    #. Delete the 'Turnkeylinux Example ' database, using the following procedure:
        ...
        #. Open a web browser and type in the Odoo URL, in my case: http://tkl-odoo14-jcafb21n-vm.
...
------------------
    ...
    #. Update host name, executing the following commands:
        ...
        ::
            ...
            HOSTNAME=tkl-odoo14-jcafb21n-vm
        ...
        * `Using an SSH Tunnel <http://confluence.dbvis.com/display/UG91/Using+an+SSH+Tunnel>`_ 
        ...
        #. :red:`(Not Used)` To  establish a secure tunnel from the remote computer, use one the following commands (change the local port (5432) and the remote port (33335) appropriately):
            ...
            ::
                ...
                ssh -v -L 33335:localhost:5432 root@tkl-odoo14-jcafb21n-vm

            ::

                ssh -L 33335:localhost:5432 root@tkl-odoo14-jcafb21n-vm

            ::

                ssh -v -L 33335:127.0.0.1:5432 root@tkl-odoo14-jcafb21n-vm

            ::

                ssh -L 33335:127.0.0.1:5432 root@tkl-odoo14-jcafb21n-vm
    ...
    #. To install Jinja2-2.11.2, execute the following commands (as root):
        ...
        * Issue:
        ...
        ::
            ...
            root@tkl-odoo14-jcafb21n-vm ~# pip3 install -U Jinja2
            Collecting Jinja2
