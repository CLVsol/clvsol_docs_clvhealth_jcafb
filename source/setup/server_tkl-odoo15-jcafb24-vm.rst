...
=================================================
Criação do Servidor Local "tkl-odoo15-jcafb24-vm"
=================================================
...
------------------
    ...
    #. Create a new Virtual Machine using the following parameters:
        ...
        - Set a VM Name and a VM Location of your preference (**tkl-odoo15-jcafb24-vm** - **D:\\vm\\tkl-odoo15-jcafb24-vm**).
...
---------------
    ...
    #. :red:`(Not Used - Failed)` Delete the 'Turnkeylinux Example ' database, using the following procedure:
        ...
        #. Open a web browser and type in the Odoo URL, in my case: http://tkl-odoo15-jcafb24-vm.
    ...
    #. Delete the 'Turnkeylinux Example' database, using the following procedure:
        ...
        #. Estabelecer uma sessão ssh com o servidor **tkl-odoo15-jcafb24-vm** e paralizar o *Odoo*:
        ...
        #. [tkl-odoo15-jcafb24-vm] Excluir a instância do *Turnkeylinux Example* existente:
        ...
        #. Retornar a execução do *Odoo* do servidor **tkl-odoo15-jcafb24-vm** ao modo manual:
...
------------------
    ...
    #. Update host name, executing the following commands:
        ...
        ::
            ...
            HOSTNAME=tkl-odoo15-jcafb24-vm
        ...
        * `Using an SSH Tunnel <http://confluence.dbvis.com/display/UG91/Using+an+SSH+Tunnel>`_ 
        ...
        #. :red:`(Not Used)` To  establish a secure tunnel from the remote computer, use one the following commands (change the local port (5432) and the remote port (33335) appropriately):
            ...
            ::
                ...
                ssh -v -L 33335:localhost:5432 root@tkl-odoo15-jcafb24-vm

            ::

                ssh -L 33335:localhost:5432 root@tkl-odoo15-jcafb24-vm

            ::

                ssh -v -L 33335:127.0.0.1:5432 root@tkl-odoo15-jcafb24-vm

            ::

                ssh -L 33335:127.0.0.1:5432 root@tkl-odoo15-jcafb24-vm
    ...
    #. :red:`(Not Used)` To install Jinja2-2.11.2, execute the following commands (as root):
        ...
        * Issue:
        ...
        ::
            ...
            root@tkl-odoo15-jcafb24-vm ~# pip3 install -U Jinja2
            Collecting Jinja2
