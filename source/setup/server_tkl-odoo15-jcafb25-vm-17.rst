...
====================================================
Criação do Servidor Local "tkl-odoo15-jcafb25-vm-17"
====================================================
...
------------------
    ...
    #. Create a new Virtual Machine using the following parameters:
        ...
        - Set a VM Name and a VM Location of your preference (**tkl-odoo15-jcafb25-vm-17** - **D:\\vm\\tkl-odoo15-jcafb25-vm-17**).
...
---------------
    ...
    #. Delete the 'Turnkeylinux Example' database, using the following procedure:
        ...
        #. Estabelecer uma sessão ssh com o servidor **tkl-odoo15-jcafb25-vm-17** e paralizar o *Odoo*:
        ...
        #. [tkl-odoo15-jcafb25-vm-17] Excluir a instância do *Turnkeylinux Example* existente:
        ...
        #. Retornar a execução do *Odoo* do servidor **tkl-odoo15-jcafb25-vm-17** ao modo manual:
...
------------------
    ...
    #. Update host name, executing the following commands:
        ...
        ::
            ...
            HOSTNAME=tkl-odoo15-jcafb25-vm-17
        ...
        * `Using an SSH Tunnel <http://confluence.dbvis.com/display/UG91/Using+an+SSH+Tunnel>`_ 
        ...
        #. :red:`(Not Used)` To  establish a secure tunnel from the remote computer, use one the following commands (change the local port (5432) and the remote port (33335) appropriately):
            ...
            ::
                ...
                ssh -v -L 33335:localhost:5432 root@tkl-odoo15-jcafb25-vm-17

            ::

                ssh -L 33335:localhost:5432 root@tkl-odoo15-jcafb25-vm-17

            ::

                ssh -v -L 33335:127.0.0.1:5432 root@tkl-odoo15-jcafb25-vm-17

            ::

                ssh -L 33335:127.0.0.1:5432 root@tkl-odoo15-jcafb25-vm-17
    ...
    #. :red:`(Not Used)` To install Jinja2-2.11.2, execute the following commands (as root):
        ...
        * Issue:
        ...
        ::
            ...
            root@tkl-odoo15-jcafb25-vm-17 ~# pip3 install -U Jinja2
            Collecting Jinja2
...
-------------------------
    ...
    #. To install all "**modules**", use the following commands (as odoo):
        ...
        ::
            ...
            ssh tkl-odoo15-jcafb25-vm-17 -l odoo
