...
.. index:: Criação do Servidor de Produção na AWS clvheatlh-jcafb-2024-aws-tst

=====================================================================
Criação do Servidor de Produção na AWS "clvheatlh-jcafb-2024-aws-tst"
=====================================================================
...
----------------------
    ...
    #. Create, via TrunKey Hub, a new Key Pair:
        ...
        * Private Key File: **clvheatlh-jcafb-2024-aws-tst.pem**
    ...
    #. Create, via TrunKey Hub, the Amazon EC2 instance clvheatlh-jcafb-2024-aws-tst-aws:
        ...
        * Basics:
            ...
            * Hostname: **clvheatlh-jcafb-2024-aws-tst**
...
---------------
    ...
    #. Delete the 'Turnkeylinux Example ' database, using the following procedure:
        ...
        #. [clvheatlh-jcafb-2024-aws-tst] Excluir a instância do *CLVhealth-JCAFB-2022v-15* existente:
        ...
        #. Retornar a execução do *Odoo* do servidor **clvheatlh-jcafb-2024-aws-tst** ao modo manual:
        ...
        * `Using an SSH Tunnel <http://confluence.dbvis.com/display/UG91/Using+an+SSH+Tunnel>`_ 
        ...
        #. :red:`(Not Used)` To  establisTrunKeyh a secure tunnel from the remote computer, use one the following commands (change the local port (5432) and the remote port (33335) appropriately):
            ...
            ::
                ...
                ssh -v -L 33335:localhost:5432 root@clvheatlh-jcafb-2024-aws-tst

            ::

                ssh -L 33335:localhost:5432 root@clvheatlh-jcafb-2024-aws-tst

            ::

                ssh -v -L 33335:127.0.0.1:5432 root@clvheatlh-jcafb-2024-aws-tst

            ::

                ssh -L 33335:127.0.0.1:5432 root@clvheatlh-jcafb-2024-aws-tst
...
-------------------------
    ...
    #. To install all "**modules**", use the following commands (as odoo):
        ...
        ::
            ...
            ssh clvheatlh-jcafb-2024-aws-tst -l odoo
