...
.. index:: Criação do Servidor de Testes na AWS clvheatlh-jcafb-2023-aws-tst

===================================================================
Criação do Servidor de Testes na AWS "clvheatlh-jcafb-2023-aws-tst"
===================================================================
...
----------------------
    ...
    #. Create, via TrunKey Hub, a new Key Pair:
        ...
        * Label: **clvheatlh-jcafb-2023-aws-tst**
        * Private Key File: **clvheatlh-jcafb-2023-aws-tst.pem**
    ...
    #. Create, via TrunKey Hub, the Amazon EC2 instance clvheatlh-jcafb-2023-aws-tst-aws:
        ...
        * Basics:
            ...
            * Hostname: **clvheatlh-jcafb-2023-aws-tst**
        ...
        * Root account:
            ...
            * Root password: "*******"
            * SSH key-pair: **clvheatlh-jcafb-2023-aws-tst**
...
---------------
    ...
    #. Delete the 'Turnkeylinux Example ' database, using the following procedure:
        ...
        #. Open a web browser and type in the Odoo URL, in my case: https://clvheatlh-jcafb-2023-aws-tst.tklapp.com.
    ...
    #. :red:`(Not Used)` Delete the 'Turnkeylinux Example ' database, using the following procedure:
        ...
        #. Estabelecer uma sessão ssh com o servidor **clvheatlh-jcafb-2023-aws-tst** e paralizar o *Odoo*:
        ...
        #. [clvheatlh-jcafb-2023-aws-tst] Excluir a instância do *CLVhealth-JCAFB-2022v-15* existente:
        ...
        #. Retornar a execução do *Odoo* do servidor **clvheatlh-jcafb-2023-aws-tst** ao modo manual:
        ...
        * `Using an SSH Tunnel <http://confluence.dbvis.com/display/UG91/Using+an+SSH+Tunnel>`_ 
        ...
        #. :red:`(Not Used)` To  establisTrunKeyh a secure tunnel from the remote computer, use one the following commands (change the local port (5432) and the remote port (33335) appropriately):
            ...
            ::
                ...
                ssh -v -L 33335:localhost:5432 root@clvheatlh-jcafb-2023-aws-tst

            ::

                ssh -L 33335:localhost:5432 root@clvheatlh-jcafb-2023-aws-tst

            ::

                ssh -v -L 33335:127.0.0.1:5432 root@clvheatlh-jcafb-2023-aws-tst

            ::

                ssh -L 33335:127.0.0.1:5432 root@clvheatlh-jcafb-2023-aws-tst
...
---------------
    ...
    #. :red:`(Not Used)` To install xlrd 1.1.0, execute the following commands (as root):
        ...
        ::
            ...
            root@clvheatlh-jcafb-2023-aws-tst .../clvsol_clvhealth_jcafb/project# pip3 install xlrd
            Requirement already satisfied: xlrd in /usr/lib/python3/dist-packages (1.1.0)
            root@clvheatlh-jcafb-2023-aws-tst .../clvsol_clvhealth_jcafb/project# pip3 install xlwt
            Collecting xlwt
            ...
            root@clvheatlh-jcafb-2023-aws-tst .../clvsol_clvhealth_jcafb/project# pip3 install xlutils
            Collecting xlutils
    ...
    #. :red:`(Not Used)` To install Jinja2-2.11.2, execute the following commands (as root):
        ...
        * Issue:
        ...
        ::
            ...
            root@clvheatlh-jcafb-2023-aws-tst ~# pip3 install -U Jinja2
            Collecting Jinja2
...
-------------------------
    ...
    #. To install all "**modules**", use the following commands (as odoo):
        ...
        ::
            ...
            ssh clvheatlh-jcafb-2023-aws-tst -l odoo
