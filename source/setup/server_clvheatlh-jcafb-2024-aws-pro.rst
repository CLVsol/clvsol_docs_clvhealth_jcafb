...
---------------
    ...
    #. :red:`(Not Used)` To install xlrd 1.1.0, execute the following commands (as root):
        ...
        ::
            ...
            root@clvheatlh-jcafb-2024-aws-pro .../clvsol_clvhealth_jcafb/project# pip3 install xlrd
            Requirement already satisfied: xlrd in /usr/lib/python3/dist-packages (1.1.0)
            root@clvheatlh-jcafb-2024-aws-pro .../clvsol_clvhealth_jcafb/project# pip3 install xlwt
            Collecting xlwt
            ...
            root@clvheatlh-jcafb-2024-aws-pro .../clvsol_clvhealth_jcafb/project# pip3 install xlutils
            Collecting xlutils
    ...
    #. :red:`(Not Used)` To install Jinja2-2.11.2, execute the following commands (as root):
        ...
        * Issue:
        ...
        ::
            ...
            root@clvheatlh-jcafb-2024-aws-pro ~# pip3 install -U Jinja2
            Collecting Jinja2
