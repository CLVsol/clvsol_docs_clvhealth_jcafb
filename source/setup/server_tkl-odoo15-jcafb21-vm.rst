...
=================================================
Criação do Servidor Local "tkl-odoo15-jcafb21-vm"
=================================================
...
------------------
    ...
    #. Create a new Virtual Machine using the following parameters:
        ...
        - Set a VM Name and a VM Location of your preference (**tkl-odoo15-jcafb21-vm** - **D:\\vm\\tkl-odoo15-jcafb21-vm**).
...
---------------
    ...
    #. Delete the 'Turnkeylinux Example ' database, using the following procedure:
        ...
        #. Open a web browser and type in the Odoo URL, in my case: http://tkl-odoo15-jcafb21-vm.
...
------------------
    ...
    #. Update host name, executing the following commands:
        ...
        ::
            ...
            HOSTNAME=tkl-odoo15-jcafb21-vm
        ...
        * `Using an SSH Tunnel <http://confluence.dbvis.com/display/UG91/Using+an+SSH+Tunnel>`_ 
        ...
        #. :red:`(Not Used)` To  establish a secure tunnel from the remote computer, use one the following commands (change the local port (5432) and the remote port (33335) appropriately):
            ...
            ::
                ...
                ssh -v -L 33335:localhost:5432 root@tkl-odoo15-jcafb21-vm

            ::

                ssh -L 33335:localhost:5432 root@tkl-odoo15-jcafb21-vm

            ::

                ssh -v -L 33335:127.0.0.1:5432 root@tkl-odoo15-jcafb21-vm

            ::

                ssh -L 33335:127.0.0.1:5432 root@tkl-odoo15-jcafb21-vm
    ...
    #. :red:`(Not Used)` To install Jinja2-2.11.2, execute the following commands (as root):
        ...
        * Issue:
        ...
        ::
            ...
            root@tkl-odoo15-jcafb21-vm ~# pip3 install -U Jinja2
            Collecting Jinja2
...
-------------------------
    ...
    #. Edit the files "**/etc/odoo/odoo.conf**" and "**/etc/odoo/odoo-man.conf**" (as root):
        ...
        ::
            ...
            # addons_path = /usr/lib/python3/dist-packages/odoo/addons
            addons_path = /usr/lib/python3/dist-packages/odoo/addons,/opt/odoo/clvsol_odoo_addons,/opt/odoo/clvsol_odoo_addons_l10n_br,/opt/odoo/clvsol_l10n_brazil,/opt/odoo/clvsol_odoo_addons_jcafb,/opt/odoo/clvsol_odoo_addons_log,/opt/odoo/clvsol_odoo_addons_sync,/opt/odoo/clvsol_odoo_addons_sync_jcafb
...
Restaurar um backup do banco de dados *CLVhealth-JCAFB-2021v-15*
----------------------------------------------------------------
