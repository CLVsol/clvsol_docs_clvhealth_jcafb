...
:borange:`(**)` Trascrição das Respostas de Termos de Consentimento via URL genérica
------------------------------------------------------------------------------------
...
:borange:`(**)` Trascrição das Respostas de Questionários via URL genérica
--------------------------------------------------------------------------
...
:borange:`(**)` Trascrição das Respostas de Questionários ou Termos de Consentimento via Documentos associados
--------------------------------------------------------------------------------------------------------------
...
:borange:`(**)` Executar a Ação *Lab Test Request Receive* para recebimento de amostras para Exame
--------------------------------------------------------------------------------------------------
...
:borange:`(**)` Trascrição de Respostas de Folhas de Resultados de Exames via URL genérica
------------------------------------------------------------------------------------------
...
Criar um backup do banco de dados *CLVhealth-JCAFB-2021v-14n* (2021-08-31a)
---------------------------------------------------------------------------
    ...
    #. [tkl-odoo14-jcafb21n-vm] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2021v_14n -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2021v_14n_2021-08-31a.sql

            gzip clvhealth_jcafb_2021v_14n_2021-08-31a.sql
            pg_dump clvhealth_jcafb_2021v_14n -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2021v_14n_2021-08-31a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-31a.tar.gz clvhealth_jcafb_2021v_14n

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-31a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        ...
        * /opt/odoo/clvhealth_jcafb_2021v_14n_2021-08-31a.sql
        * /opt/odoo/clvhealth_jcafb_2021v_14n_2021-08-31a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-31a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-31a.tar.gz

.. index:: clvhealth_jcafb_2021v_14n_2021-08-31a.sql
.. index:: clvhealth_jcafb_2021v_14n_2021-08-31a.sql.gz
.. index:: filestore_clvhealth_jcafb_2021v_14n_2021-08-31a
.. index:: clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-31a

Restaurar um backup do banco de dados *CLVhealth-JCAFB-2021v-14n* (2021-08-31a)
-------------------------------------------------------------------------------
    ...
    #. [tkl-odoo14-jcafb21n-vm] Executar os comandos de restauração dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            # gzip -d clvhealth_jcafb_2021v_14n_2021-08-31a.sql.gz

            dropdb -i clvhealth_jcafb_2021v_14n

            createdb -O odoo -E UTF8 -T template0 clvhealth_jcafb_2021v_14n
            psql -f clvhealth_jcafb_2021v_14n_2021-08-31a.sql -d clvhealth_jcafb_2021v_14n -U postgres -h localhost -p 5432 -q

            # mkdir /var/lib/odoo/.local/share/Odoo/filestore
            cd /var/lib/odoo/.local/share/Odoo/filestore
            rm -rf clvhealth_jcafb_2021v_14n
            tar -xzvf /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-31a.tar.gz

            # mkdir /opt/odoo/clvsol_filestore
            cd /opt/odoo/clvsol_filestore
            rm -rf clvhealth_jcafb
            tar -xzvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-31a.tar.gz
...
:borange:`(**)` Trascrição de Respostas de Folhas de Resultados via Resultados de Exame associados
--------------------------------------------------------------------------------------------------
...
Criar um backup do banco de dados *CLVhealth-JCAFB-2021v-14n* (2021-08-31b)
---------------------------------------------------------------------------
    ...
    #. [tkl-odoo14-jcafb21n-vm] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2021v_14n -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2021v_14n_2021-08-31b.sql

            gzip clvhealth_jcafb_2021v_14n_2021-08-31b.sql
            pg_dump clvhealth_jcafb_2021v_14n -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2021v_14n_2021-08-31b.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-31b.tar.gz clvhealth_jcafb_2021v_14n

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-31b.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        ...
        * /opt/odoo/clvhealth_jcafb_2021v_14n_2021-08-31b.sql
        * /opt/odoo/clvhealth_jcafb_2021v_14n_2021-08-31b.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-31b.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-31b.tar.gz

.. index:: clvhealth_jcafb_2021v_14n_2021-08-31b.sql
.. index:: clvhealth_jcafb_2021v_14n_2021-08-31b.sql.gz
.. index:: filestore_clvhealth_jcafb_2021v_14n_2021-08-31b
.. index:: clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-31b

Restaurar um backup do banco de dados *CLVhealth-JCAFB-2021v-14n* (2021-08-31b)
-------------------------------------------------------------------------------
    ...
    #. [tkl-odoo14-jcafb21n-vm] Executar os comandos de restauração dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            # gzip -d clvhealth_jcafb_2021v_14n_2021-08-31b.sql.gz

            dropdb -i clvhealth_jcafb_2021v_14n

            createdb -O odoo -E UTF8 -T template0 clvhealth_jcafb_2021v_14n
            psql -f clvhealth_jcafb_2021v_14n_2021-08-31b.sql -d clvhealth_jcafb_2021v_14n -U postgres -h localhost -p 5432 -q

            # mkdir /var/lib/odoo/.local/share/Odoo/filestore
            cd /var/lib/odoo/.local/share/Odoo/filestore
            rm -rf clvhealth_jcafb_2021v_14n
            tar -xzvf /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-31b.tar.gz

            # mkdir /opt/odoo/clvsol_filestore
            cd /opt/odoo/clvsol_filestore
            rm -rf clvhealth_jcafb
            tar -xzvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-31b.tar.gz
...
:borange:`(**)` Executar a Ação *Lab Test Result Criteria Refresh* para Resultados de Exames do Projeto JCAFB-2021v
-------------------------------------------------------------------------------------------------------------------
