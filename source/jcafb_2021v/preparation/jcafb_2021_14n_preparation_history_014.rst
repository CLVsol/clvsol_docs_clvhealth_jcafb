...
Criar um backup do banco de dados *CLVhealth-JCAFB-2021v-14n* (2021-08-29a)
---------------------------------------------------------------------------
    ...
    #. [tkl-odoo14-jcafb21n-vm] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2021v_14n -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2021v_14n_2021-08-29a.sql

            gzip clvhealth_jcafb_2021v_14n_2021-08-29a.sql
            pg_dump clvhealth_jcafb_2021v_14n -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2021v_14n_2021-08-29a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-29a.tar.gz clvhealth_jcafb_2021v_14n

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-29a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        ...
        * /opt/odoo/clvhealth_jcafb_2021v_14n_2021-08-29a.sql
        * /opt/odoo/clvhealth_jcafb_2021v_14n_2021-08-29a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-29a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-29a.tar.gz

.. index:: clvhealth_jcafb_2021v_14n_2021-08-29a.sql
.. index:: clvhealth_jcafb_2021v_14n_2021-08-29a.sql.gz
.. index:: filestore_clvhealth_jcafb_2021v_14n_2021-08-29a
.. index:: clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-29a

Restaurar um backup do banco de dados *CLVhealth-JCAFB-2021v-14n* (2021-08-29a)
-------------------------------------------------------------------------------
    ...
    #. [tkl-odoo14-jcafb21n-vm] Executar os comandos de restauração dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            # gzip -d clvhealth_jcafb_2021v_14n_2021-08-29a.sql.gz

            dropdb -i clvhealth_jcafb_2021v_14n

            createdb -O odoo -E UTF8 -T template0 clvhealth_jcafb_2021v_14n
            psql -f clvhealth_jcafb_2021v_14n_2021-08-29a.sql -d clvhealth_jcafb_2021v_14n -U postgres -h localhost -p 5432 -q

            # mkdir /var/lib/odoo/.local/share/Odoo/filestore
            cd /var/lib/odoo/.local/share/Odoo/filestore
            rm -rf clvhealth_jcafb_2021v_14n
            tar -xzvf /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-29a.tar.gz

            # mkdir /opt/odoo/clvsol_filestore
            cd /opt/odoo/clvsol_filestore
            rm -rf clvhealth_jcafb
            tar -xzvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-29a.tar.gz
...
Criar um backup do banco de dados *CLVhealth-JCAFB-2021v-14n* (2021-08-30a)
---------------------------------------------------------------------------
    ...
    #. [tkl-odoo14-jcafb21n-vm] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2021v_14n -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2021v_14n_2021-08-30a.sql

            gzip clvhealth_jcafb_2021v_14n_2021-08-30a.sql
            pg_dump clvhealth_jcafb_2021v_14n -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2021v_14n_2021-08-30a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-30a.tar.gz clvhealth_jcafb_2021v_14n

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-30a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        ...
        * /opt/odoo/clvhealth_jcafb_2021v_14n_2021-08-30a.sql
        * /opt/odoo/clvhealth_jcafb_2021v_14n_2021-08-30a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-30a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-30a.tar.gz

.. index:: clvhealth_jcafb_2021v_14n_2021-08-30a.sql
.. index:: clvhealth_jcafb_2021v_14n_2021-08-30a.sql.gz
.. index:: filestore_clvhealth_jcafb_2021v_14n_2021-08-30a
.. index:: clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-30a

Restaurar um backup do banco de dados *CLVhealth-JCAFB-2021v-14n* (2021-08-30a)
-------------------------------------------------------------------------------
    ...
    #. [tkl-odoo14-jcafb21n-vm] Executar os comandos de restauração dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            # gzip -d clvhealth_jcafb_2021v_14n_2021-08-30a.sql.gz

            dropdb -i clvhealth_jcafb_2021v_14n

            createdb -O odoo -E UTF8 -T template0 clvhealth_jcafb_2021v_14n
            psql -f clvhealth_jcafb_2021v_14n_2021-08-30a.sql -d clvhealth_jcafb_2021v_14n -U postgres -h localhost -p 5432 -q

            # mkdir /var/lib/odoo/.local/share/Odoo/filestore
            cd /var/lib/odoo/.local/share/Odoo/filestore
            rm -rf clvhealth_jcafb_2021v_14n
            tar -xzvf /opt/odoo/filestore_clvhealth_jcafb_2021v_14n_2021-08-30a.tar.gz

            # mkdir /opt/odoo/clvsol_filestore
            cd /opt/odoo/clvsol_filestore
            rm -rf clvhealth_jcafb
            tar -xzvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_14n_2021-08-30a.tar.gz
...
:borange:`(**)` Trascrição das Respostas de Folhas de Resultados de Exames via URL genérica
-------------------------------------------------------------------------------------------
