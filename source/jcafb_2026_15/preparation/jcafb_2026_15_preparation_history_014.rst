...
[tkl-odoo15-jcafb26-vm] Executar a Verificação de todos os Pacientes
--------------------------------------------------------------------

    #. Conectar-se, via *browser*, ao *Odoo* do servidor `tkl-odoo15-jcafb26-vm <https://tkl-odoo15-jcafb26-vm>`_

    #. Executar a Ação :bi:`Patient Verification Execute` para todos os Pacientes:
...
------------------------------------------------------
    ...
    #. Escluir manualmente todos os :bi:`File System Files` do :bi:`File System Directory` "**Summary Files**":
        ...
        * Menu de acesso:
        ...
        #. Selecionar todas os :bi:`File System Files` referentes a "**Summary Files**" (**nn**)
    ...
    #. Executar a Ação :bi:`Employee Mass Edit` para todos os :bi:`Funcionários`:
        ...
        #. Selecionar todos os :bi:`Funcionários` (**nn**)
    ...
    #. [tkl-odoo15-jcafb26-vm] Excluir todos os **Summaries**:
        ...
        #. Selecionar todos os :bi:`Summaries` (**nn**)
...
--------------------------------------------------------------------------------
    ...
    #. Conectar-se, via *browser*, ao *Odoo* do servidor `tkl-odoo15-jcafb26-vm <https://tkl-odoo15-jcafb26-vm>`_
        ...
        #. Selecionar todas as :bi:`Residences` (**nn**)
...
---------------------------------------------------------------------------------------
    ...
    #. Excluir os :bi:`Contact Information Patterns` sem :bi:`Matches`:
        ...
        #. Selecionar os :bi:`Contact Information Patterns` com :bi:`Number of Matches` = **0** (**nn**)
...
--------------------------------------------------------------------------
    ...
    #. Excluir os :bi:`Street Patterns` sem :bi:`Matches`:
        ...
        #. Selecionar os :bi:`Street Patterns` com :bi:`Number of Matches` = **0** (**nn**)
