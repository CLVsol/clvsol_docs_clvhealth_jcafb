...
.. index:: Street Pattern was not recognised. [_patient_verification]

================================================================
**"Street Pattern" was not recognised.** [_patient_verification]
================================================================
    ...
    Essa situação é corrigida, utilizando o procedimento de correção : :doc:`reregistration_procedure_040_030_005`.
