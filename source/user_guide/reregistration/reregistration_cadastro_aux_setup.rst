...
A Preparação do Cadastro Auxiliar é implementada através das seguintes ações:
    ...
    #. Excluir todos os registros de Pacientes do Cadastro Auxiliar executando o procedimento ":doc:`/procedures/reregistration/reregistration_procedure_cadastro_aux_setup_010`".

    #. Associar todos os Pacientes a um Paciente (Aux) executando o procedimento ":doc:`/procedures/reregistration/reregistration_procedure_cadastro_aux_setup_030`".

    #. Remover a Fase de todos os Pacientes (Aux) executando o procedimento ":doc:`/procedures/reregistration/reregistration_procedure_cadastro_aux_setup_050`".

    #. :red:`(Não Executado])` Excluir todos os registros de Pacientes falecidas do Cadastro Auxiliar executando o procedimento ":doc:`/procedures/reregistration/reregistration_procedure_cadastro_aux_setup_070`".
