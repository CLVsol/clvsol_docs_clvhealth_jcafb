...
.. index:: Patient (Aux) Remove Category (Procedimento)

==================================================
:bi:`Patient (Aux) Remove Category` (Procedimento)
==================================================

    * *Workflow*: ":doc:`reregistration_workflow_030_020_020_080`".
    ...
    #. Exercutar a Ação ":bi:`Patient (Aux) Mass Edit`":
        ...
        #. Parâmetros apresentados:
            ...
            * *Register State*: **Nenhuma ação**
            * *State*: **Nenhuma ação**
            * *Categories*: :bi:`Remove` » **todas as Categorias definidas**
            * *Phase*: **Nenhuma ação**
