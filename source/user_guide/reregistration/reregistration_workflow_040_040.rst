...
===============================
    ...
    O Processo de Consolidação de :bi:`Residence` é feito guiando-se pelo :bi:`Verification State` e :bi:`Verification Outcomes` de cada registro :bi:`Residence`.
    ...
    Os estados diferentes de "**Ok**" são classificados em 3 níveis de "**L0**", "**L1**" e "**L2**" (não existe no momento a ocorrencia do nivel "**L2**"):
      ...
      * "**L0**": ("Error (L0)" ou "Warning (L0)") sinalizam um Erro ou Advertência ocorrendo no próprio registro :bi:`Residence`.

      * "**L1**": ("Error (L1)" ou "Warning (L1)") sinalizam um Erro ou Advertência ocorrendo no registro de uma outra Entidade de Cadastro relacionada ao registro :bi:`Residence`.
    ...
    De forma geral, o Processo de Consolidação de :bi:`Residence` segue a ordem:

      #. :doc:`reregistration_workflow_040_040_010`

      #. :doc:`reregistration_workflow_040_040_020`

      #. :doc:`reregistration_workflow_040_040_030`
...
.. toctree::
   ...
   reregistration_workflow_040_040_020
   reregistration_workflow_040_040_030
