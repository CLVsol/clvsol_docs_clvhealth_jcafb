...
[tkl-odoo15-jcafb24-vm] Atualizar o(s) módulo(s) [clv_patient_history]
----------------------------------------------------------------------
...
[tkl-odoo15-jcafb24-vm] Criar um backup do banco de dados *CLVhealth-JCAFB-2024-15* (2023-08-18a)
-------------------------------------------------------------------------------------------------
    ...
    #. [tkl-odoo15-jcafb24-vm] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2024_15 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2024_15_2023-08-18a.sql

            gzip clvhealth_jcafb_2024_15_2023-08-18a.sql
            pg_dump clvhealth_jcafb_2024_15 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2024_15_2023-08-18a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2024_15_2023-08-18a.tar.gz clvhealth_jcafb_2024_15

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2024_15_2023-08-18a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        ...
        * /opt/odoo/clvhealth_jcafb_2024_15_2023-08-18a.sql
        * /opt/odoo/clvhealth_jcafb_2024_15_2023-08-18a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2024_15_2023-08-18a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2024_15_2023-08-18a.tar.gz

.. index:: clvhealth_jcafb_2024_15_2023-08-18a.sql
.. index:: clvhealth_jcafb_2024_15_2023-08-18a.sql.gz
.. index:: filestore_clvhealth_jcafb_2024_15_2023-08-18a
.. index:: clvsol_filestore_clvhealth_jcafb_2024_15_2023-08-18a

[tkl-odoo15-jcafb24-vm] Restaurar um backup do banco de dados *CLVhealth-JCAFB-2024-15* (2023-08-18a)
-----------------------------------------------------------------------------------------------------
    ...
    #. [tkl-odoo15-jcafb24-vm] Executar os comandos de restauração dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            # gzip -d clvhealth_jcafb_2024_15_2023-08-18a.sql.gz

            dropdb -i clvhealth_jcafb_2024_15

            createdb -O odoo -E UTF8 -T template0 clvhealth_jcafb_2024_15
            psql -f clvhealth_jcafb_2024_15_2023-08-18a.sql -d clvhealth_jcafb_2024_15 -U postgres -h localhost -p 5432 -q

            # mkdir /var/lib/odoo/.local/share/Odoo/filestore
            cd /var/lib/odoo/.local/share/Odoo/filestore
            rm -rf clvhealth_jcafb_2024_15
            tar -xzvf /opt/odoo/filestore_clvhealth_jcafb_2024_15_2023-08-18a.tar.gz

            # mkdir /opt/odoo/clvsol_filestore
            cd /opt/odoo/clvsol_filestore
            rm -rf clvhealth_jcafb
            tar -xzvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2024_15_2023-08-18a.tar.gz
...
[tkl-odoo15-jcafb24-vm] Criar um backup do banco de dados *CLVhealth-JCAFB-2024-15* (2023-08-18b)
-------------------------------------------------------------------------------------------------
    ...
    #. [tkl-odoo15-jcafb24-vm] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2024_15 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2024_15_2023-08-18b.sql

            gzip clvhealth_jcafb_2024_15_2023-08-18b.sql
            pg_dump clvhealth_jcafb_2024_15 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2024_15_2023-08-18b.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2024_15_2023-08-18b.tar.gz clvhealth_jcafb_2024_15

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2024_15_2023-08-18b.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        ...
        * /opt/odoo/clvhealth_jcafb_2024_15_2023-08-18b.sql
        * /opt/odoo/clvhealth_jcafb_2024_15_2023-08-18b.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2024_15_2023-08-18b.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2024_15_2023-08-18b.tar.gz

.. index:: clvhealth_jcafb_2024_15_2023-08-18b.sql
.. index:: clvhealth_jcafb_2024_15_2023-08-18b.sql.gz
.. index:: filestore_clvhealth_jcafb_2024_15_2023-08-18b
.. index:: clvsol_filestore_clvhealth_jcafb_2024_15_2023-08-18b
