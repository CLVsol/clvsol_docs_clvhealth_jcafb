...
====================================================================
    ...
    Para alterar o parâmetro *Phase* do  registro *Address*, utilizar o procedimento de correção: :doc:`/procedures/reregistration/reregistration_procedure_030_010_030`.

    Para reverter o parâmetro *Phase* do  registro *Address (Aux)*, utilizar o procedimento de correção: :doc:`/procedures/reregistration/reregistration_procedure_030_010_040`.
