...
=================================================================================
    ...
    Esta situação é a desejada quando o registro *Address* tiver sido "Cancelado" (*Register State* = "*Canceled*"). Neste caso, não é necessária a execução de qualquer procedimento de correção no registro *Address*.
