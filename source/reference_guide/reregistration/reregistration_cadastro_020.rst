...
As informações de Endereço do :bi:`Contact Information` das 2 Entidades do Cadastro (Aux) inter-relacionadas devem ser idênticas.

.. toctree::
   :maxdepth: 2
   :caption: Itens Relacionados:

   reregistration_cadastro_020_010
   reregistration_cadastro_020_030
