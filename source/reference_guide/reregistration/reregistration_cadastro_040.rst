...
Todas as ações de verificação das informações registradas nos **Cadastros** objetivam mater o sincronismo dentre os dados armazenados para as Pessoas e seus respectivos Endereços nos **Cadastro Auxiliar** e **Cadastro Principal**. Alterações em qualquer um dos Cadastros são sempre percebidas e sinalizadas durante essas ações de verificação.
